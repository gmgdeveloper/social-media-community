...
class Profile extends Controller
{
    ...
    function upload_photo($photo_type, Request $request)
    {
        ...
        if ($photo_type == 'cover_photo') {
            ...
            $public_path = public_path('/storage/cover_photo');

            $file_name = FileUploader::upload($request->cover_photo, $public_path, 1120);
    ...
    function update_profile(Request $request)
    {
        ...
        if ($request->profile_photo && !empty($request->profile_photo)) {
            ...
            $public_path = public_path('/storage/userimage/');
            $file_name = FileUploader::upload($request->profile_photo,$public_path, 800);

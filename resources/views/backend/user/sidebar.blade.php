<div class="sidebar">
      <div class="logo-details mt-4">
        <div class="img_wrapper">
          ...
          @endphp
          <img class="logo-lg" height="34px" src="{{ url('storage/logo/light/'.$system_light_logo,) }}" alt="" />
          <img class="logo-sm" height="34px" src="{{ url('storage/logo/favicon/'.$system_light_logo) }}" alt="" />
        </div>
      </div>
      <div class="closeIcon">

<div class="home-header">
    <div class="row w-100 justify-content-between align-items-center">
      <div class="col-auto d-flex">
        ...
        <div class=" ms-4">
          <a href="{{ url('/timeline') }}" class="btn btn-outline-primary" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Visit Website')}}"><i class="bi bi-globe d-inline-block d-md-none"></i> <span class="d-md-inline-block d-none">{{get_phrase('Visit Website')}}</span></a>
        </div>
      </div>

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-secondary">
                                            <img src="{{ url('storage/logo/light/'.$system_light_logo,) }}" class="mx-4 my-5" width="200px" alt="...">
                                            <div class="eCard-body">
                                    ...
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="eCard d-block text-center bg-light">
                                            <img src="{{ url('/storage/logo/favicon/'.$system_fav_icon,'favicon') }}" class="mx-4 my-5" width="53px" height="60px" alt="...">
                                            <div class="eCard-body">

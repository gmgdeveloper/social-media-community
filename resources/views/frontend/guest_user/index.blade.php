...
<body>
    ...
    @include('frontend.guest_user.header')
    ...
    <main class="main my-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    @include('frontend.guest_user.left_navigation')
                </div>
                ...
                <div class="col-lg-3 order-2 order-lg-3">
                    @include('frontend.guest_user.right_sidebar')
                </div>
            </div> <!-- row end -->
    ...
    <!-- Common modals -->
    @include('frontend.guest_user.modal')

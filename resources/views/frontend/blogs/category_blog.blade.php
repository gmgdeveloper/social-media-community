<div class="page-wrap">
    <div class="d-flex pagetab-head  border align-items-center justify-content-between mb-3 py-2 px-3 rounded bg-white">
        <h3 class="h5 pt-3"><span><img width="12" src="{{ url('assets/frontend/images/stickies-fill.png') }}" alt=""></span> {{ get_phrase('Blogs') }}</h3>
        ...
        @foreach ($blogs as $blog )
            <div class="col-lg-4" id="blog-{{ $blog->id }}">
                <article class="single-entry">
                    <div class="entry-img">
                        <a href="{{ route('single.blog',$blog->id) }}"><img src="{{ get_blog_image($blog->thumbnail,'thumbnail') }}" alt="" class="img-fluid"></a>

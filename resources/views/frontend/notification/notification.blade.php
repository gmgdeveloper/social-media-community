...
">
        <div class="d-flex">
            <div class="noti-avata me-3"><img width="48" class="rounded-circle" src="{{url('storage/userimage/default.png')}}" alt="" style="
                width: 47px;
                height: 47px;
            ">
            ...
            <div class="noti-details">
                <h4><a href="{{url('storage/userimage/default.png')}}">User</a><span> accepted

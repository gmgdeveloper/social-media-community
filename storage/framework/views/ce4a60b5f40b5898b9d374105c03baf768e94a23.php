        ...
        <div class="col-lg-7 col-sm-12">
            ...
            <div class="people-wrap p-3 border bg-white">
                <div class="member-entry gr-search">
                    ...
                    <p><?php echo e(get_phrase('All  people and  who join this Community will appear here')); ?></p>
                                ...
                                <div class="post-controls dropdown dotted">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="javascript:void(0)" onclick="ajaxAction('<?php echo route('group.rjoin',$group->id); ?>')">
                                                <?php echo e(get_phrase('Leave Community')); ?></a></li>
                                    </ul>
                                </div>
                                <?php endif; ?>
                            </div>
...
</div><!-- Group content End --><?php /**PATH D:\laragon\www\social-media-comunity\resources\views/frontend/groups/all_people.blade.php ENDPATH**/ ?>
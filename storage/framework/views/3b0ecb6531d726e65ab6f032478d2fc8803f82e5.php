    ...
    <?php if(array_key_exists($user_info->id, $user_reacts)): ?>
        <?php if($user_reacts[$user_info->id] == 'like'): ?>
            <div class="like-color">
                <img class="w-17px mt--6px" src="<?php echo e(url('storage/images/liked.svg')); ?>" alt="">
        ...
        <?php if($user_reacts[$user_info->id] == 'love'): ?>
            <div class="love-color">
                <img class="w-22px mt--4px" src="<?php echo e(url('storage/images/love.svg')); ?>" alt="">
        ...
        <?php if($user_reacts[$user_info->id] == 'haha'): ?>
            <div class="sad-color">
                <img class="w-17px mt--4px" src="<?php echo e(url('storage/images/haha.svg')); ?>" alt="">
        ...
        <?php if($user_reacts[$user_info->id] == 'angry'): ?>
            <div class="angry-color">
                <img class="w-17px mt--4px" src="<?php echo e(url('storage/images/angry.svg')); ?>" alt="">
        ...
        <?php if($user_reacts[$user_info->id] == 'sad'): ?>
            <div class="sad-color">
                <img class="w-17px mt--4px" src="<?php echo e(url('storage/images/sad.svg')); ?>" alt="">
                Sad
            </div>
        <?php endif; ?>
    <?php else: ?>
        ...
        <?php else: ?>
            <div>
                <img class="w-17px mt--6px" src="<?php echo e(url('storage/images/like2.svg')); ?>" alt="">
             <?php if(isset($type)&&$type=="shorts"): ?>  <?php else: ?> <?php echo e(get_phrase('Like')); ?> <?php endif; ?> </div>
        <?php endif; ?>
    <?php endif; ?>
<?php endif; ?>

<?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/main_content/post_reacts.blade.php ENDPATH**/ ?>
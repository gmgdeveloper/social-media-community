    ...
    <div class="group-content profile-content">
        <div class="row gx-3">
            <div class="col-lg-7 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <?php echo e(get_phrase('join Community First')); ?>
...
<?php echo $__env->make('frontend.main_content.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\social-media-comunity\resources\views/frontend/groups/discuss.blade.php ENDPATH**/ ?>
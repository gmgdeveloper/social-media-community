                    ...
                    <?php if($media_file->file_type == 'video'): ?>
                        <?php if(File::exists('public/storage/story/videos/'.$media_file->file_name)): ?>
                            <video muted controlsList="nodownload" class="plyr-js initialized">
                                <source src="<?php echo e(url('storage/story/videos/'.$media_file->file_name)); ?>" type="">
                            </video>
                        <?php endif; ?>
                    <?php else: ?>
                        <figure class="avatar-img rounded" style="background-image: url(<?php echo e(url('storage/story/images/'.$media_file->file_name)); ?>)"></figure>
                    <?php endif; ?>
...
<?php echo $__env->make('frontend.story.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/story/index.blade.php ENDPATH**/ ?>
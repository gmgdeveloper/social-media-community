        ...
        <div class="comment-details" >
            ...
            <ul class="nav mt-3">
                <li class="nav-item post-react">
                    ...
                    <ul class="react-list">
                        <li><a href="javascript:void(0)" onclick="myCommentReact('like', 'update', <?php echo e($comment->comment_id); ?>)"><img src="<?php echo e(url('storage/images/like.svg')); ?>" class="" alt="Like" style="margin-right: 1px;"></a>
                        </li>
                        <li><a href="javascript:void(0)" onclick="myCommentReact('love', 'update', <?php echo e($comment->comment_id); ?>)"><img src="<?php echo e(url('storage/images/love.svg')); ?>" alt="Love" style="width: 30px; margin-top: 2px;"></a>
                        </li>
                        <li><a href="javascript:void(0)" onclick="myCommentReact('haha', 'update', <?php echo e($comment->comment_id); ?>)"><img src="<?php echo e(url('storage/images/haha.svg')); ?>" alt="Angry"></a>
                        </li>
                        <li><a href="javascript:void(0)" onclick="myCommentReact('sad', 'update', <?php echo e($comment->comment_id); ?>)"><img src="<?php echo e(url('storage/images/sad.svg')); ?>" class="mx-1" alt="Sad"></a>
                        </li>
                        <li><a href="javascript:void(0)" onclick="myCommentReact('angry', 'update', <?php echo e($comment->comment_id); ?>)"><img src="<?php echo e(url('storage/images/angry.svg')); ?>" alt="Angry"></a>
                        </li>
                    </ul>
                </li>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/main_content/comments.blade.php ENDPATH**/ ?>
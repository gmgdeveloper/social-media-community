<div class="home-header">
    <div class="row w-100 justify-content-between align-items-center">
      <div class="col-auto d-flex">
        ...
        <div class=" ms-4">
          <a href="<?php echo e(url('/timeline')); ?>" class="btn btn-outline-primary" data-bs-toggle="tooltip" data-bs-title="<?php echo e(get_phrase('Visit Website')); ?>"><i class="bi bi-globe d-inline-block d-md-none"></i> <span class="d-md-inline-block d-none"><?php echo e(get_phrase('Visit Website')); ?></span></a>
        </div>
      </div>
  ...
  </div><?php /**PATH D:\laragon\www\social-media-comunity\resources\views/backend/header.blade.php ENDPATH**/ ?>
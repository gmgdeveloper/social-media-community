<div class="sidebar">
      <div class="logo-details mt-4">
        <div class="img_wrapper">
          ...
          ?>
          <img class="logo-lg" height="34px" src="<?php echo e(url('storage/logo/light/'.$system_light_logo)); ?>" alt="" />
          <img class="logo-sm" height="34px" src="<?php echo e(url('storage/logo/favicon/'.$system_light_logo)); ?>" alt="" />
    ...
    </div><?php /**PATH D:\laragon\www\social-media-comunity\resources\views/backend/admin/sidebar.blade.php ENDPATH**/ ?>
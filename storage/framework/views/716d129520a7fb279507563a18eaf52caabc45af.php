            ...
            <div class="modal-content">
                <div class="modal-header text-center">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        ...
                        <?php else: ?>
                         <h5 class="modal-title" id="exampleModalLabel"><?php echo e(get_phrase('Please Register Or Login First ')); ?></h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="modal-footer text-center justify-content-center p-3">
                                    <button type="button" data-tab="tab-file" class="btn btn-secondary"><img
                                            src="<?php echo e(url('storage/images/image.svg')); ?>" alt="photo"><?php echo e(get_phrase('Photo')); ?>/<?php echo e(get_phrase('Video')); ?></button>

                                    <button type="button" data-tab="tab-tag" class="btn btn-secondary"><img
                                            src="<?php echo e(url('storage/images/peoples.png')); ?>" alt="photo"><?php echo e(get_phrase('Tag People')); ?></button>
                                    <button type="button" data-tab="tab-feeling" class="btn btn-secondary"><img
                                            src="<?php echo e(url('storage/images/forum.svg')); ?>" alt="photo"><?php echo e(get_phrase('Feelings')); ?> / <?php echo e(get_phrase('Activity')); ?></button>
                                    <button type="button" onclick="loadMaps('map')" data-tab="tab-location" class="btn btn-secondary"><img
                                            src="<?php echo e(url('storage/images/location.png')); ?>" alt="photo"><?php echo e(get_phrase('Location')); ?></button>
                                    <button type="button" class="btn btn-secondary" onclick="confirmLiveStreaming()"><img src="<?php echo e(url('storage/images/camera.svg')); ?>"
...
<?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/main_content/create_post_modal.blade.php ENDPATH**/ ?>
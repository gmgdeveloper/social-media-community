<div class="row gx-3">
    <div class="col-lg-7">
        <div class="group-inner bg-white border rounded p-3">
            <div class="gr-search">
                <h3 class="h6"><span><i class="fa-solid fa-users"></i></span><?php echo e(get_phrase('Communities')); ?> </h3>
...
</div><?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/groups/groups.blade.php ENDPATH**/ ?>
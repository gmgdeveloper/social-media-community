            ...
            <div class="row">
                <div class="col-lg-2 col-sm-4">
                    <div class="logo-branding">
                        <button class="d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                            <i class="fw-bold fa-solid fa-sliders-h"></i>
                        </button>
                        <!-- logo -->
                        <?php
                        // Fetch the system light logo from the database
                        $system_light_logo = \App\Models\Setting::where('type', 'system_light_logo')->value('description');


                        ?>
                        <a class="navbar-brand mt-2" href="<?php echo e(url('/timeline')); ?>">
                            <!-- Check if the logo is available -->
                            <?php if($system_light_logo): ?>
                            <!-- If the logo exists, display it -->
                            <img src="<?php echo e(url('storage/logo/light/' . $system_light_logo)); ?>" class="" width="70px" alt="logo" />
                            <?php else: ?>
                            <!-- If the logo doesn't exist, display a default image or text -->
                            <img src="<?php echo e(url('storage/logo/favicon/'.$system_light_logo)); ?>" class="logo_height_width" alt="logo" />
                            <?php endif; ?>
                        </a>
                    </div>
                        ...
                        <div class="align-items-center d-flex justify-content-around">
                            ...
                            <div class="profile-control dropdown">
                                ...
                                <button class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo e(get_guest_image(auth()->user()->photo,'optimized')); ?>" class="rounded-circle" alt="" width="50px">
                                </button>
...
<!-- Header End --><?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/guest_user/header.blade.php ENDPATH**/ ?>
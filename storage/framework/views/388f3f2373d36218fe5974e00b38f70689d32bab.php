...
<div class="col-lg-5">
        ...
        <?php endif; ?>
            ...
            <div class="widget">
                <div class="gr-search">
                    <h3 class="h6"><?php echo e(get_phrase('Communities')); ?></h3>
            ...
            <div class="widget group-widget">
                <h3 class="widget-title"><?php echo e(get_phrase('Community you Manage')); ?></h3>
            ...
            <div class="widget group-widget">
                <h3 class="widget-title"><?php echo e(get_phrase('Community you Joined')); ?></h3>
...
<?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/groups/right-sidebar.blade.php ENDPATH**/ ?>
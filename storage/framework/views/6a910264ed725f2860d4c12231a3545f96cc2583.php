            ...
            <div class="entry-header d-flex justify-content-between">
                ...
                <div class="post-controls dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="javascript:void(0)" value="copy" onclick="copyToClipboard('copy_post_<?php echo e($post->post_id); ?>')" ><img src="<?php echo e(url('storage/images/link.png')); ?>" alt=""><?php echo e(get_phrase('Copy Link')); ?></a></li>
                        <?php if($post->user_id == auth()->user()->id): ?>
                        ...
                        <li><a class="dropdown-item" href="javascript:void(0)" onclick="showCustomModal('<?php echo e(route('load_modal_content', ['view_path' => 'frontend.main_content.create_report','post_id'=>$post->post_id])); ?>', '<?php echo e(get_phrase('Report Post')); ?>');" data-bs-toggle="modal"
                            data-bs-target="#createEvent"><img src="<?php echo e(url('storage/images/report.png')); ?>" alt=""><?php echo e(get_phrase('Report')); ?>
            ...
            <div class="entry-footer">
                <div class="footer-share pt-3 d-flex justify-content-around">
                    <span class="entry-react post-react">
                        ...
                        <ul class="react-list">
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'like', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(url('storage/images/like.svg')); ?>" alt="Like" style="margin-right: 1px;"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'love', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(url('storage/images/love.svg')); ?>" alt="Love" style="width: 30px; margin-top: 2px;"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'haha', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(url('storage/images/haha.svg')); ?>" alt="Haha"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'sad', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(url('storage/images/sad.svg')); ?>" class="mx-1" alt="Sad"></a>
                            </li>
                            <li><a href="javascript:void(0)" onclick="myReact('post', 'angry', 'update', <?php echo e($post->post_id); ?>)"><img src="<?php echo e(url('storage/images/angry.svg')); ?>" alt="Angry"></a>
                            </li>
                        </ul>
                    </span>
...
<?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/main_content/posts.blade.php ENDPATH**/ ?>
...
<form class="ajaxForm" action="<?php echo e(route('group.update',$group->id)); ?>" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="w-100 btn btn-primary"><?php echo e(get_phrase('Edit Community')); ?></button>
</form>


<?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\social-media-comunity\resources\views/frontend/groups/edit-modal.blade.php ENDPATH**/ ?>
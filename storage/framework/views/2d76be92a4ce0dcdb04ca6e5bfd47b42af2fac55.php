...
<body>
    ...
    <?php echo $__env->make('frontend.guest_user.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <main class="main my-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <?php echo $__env->make('frontend.guest_user.left_navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                ...
                <div class="col-lg-3 order-2 order-lg-3">
                    <?php echo $__env->make('frontend.guest_user.right_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div> <!-- row end -->
    ...
    <!-- Common modals -->
    <?php echo $__env->make('frontend.guest_user.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH E:\laragon\www\gmg\Socail App Laravel\Sociopro\resources\views/frontend/guest_user/index.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <link href="<?php echo e(url('assets/plugins/dropify/css/dropify.min.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <script src="<?php echo e(url('assets/plugins/dropify/js/dropify.min.js')); ?>"></script>
